...
//
class CatMakesController extends BaseController
{
    ...
    public static $table_name = "cat_makes";
    ...
    public function ViewIndex($request, $response, $args) {
        //
        return $this->container->php_view->render($response, 'admin/buses/cat_makes.phtml', [
    ...
    public function GetRecord($request, $response, $args) {
        ...
        //
        $results = CatMakes::GetRecordById( $account_id, $args['id'] );
        //var_dump($results); exit;
    ...
    public function AddRecord($request, $response, $args) {
        ...
        $insert_results = Query::DoTask([
            ...
            "debug" => true,
            "stmt" => "
                   Insert Into cat_makes
                  ( account_id, nombre, fa_icon, url, 
    ...
    public function DeleteRecord($request, $response, $args) {
        ...
        $results = Query::DoTask([
            "task" => "delete",
            "stmt" => "Delete FROM cat_makes Where account_id = ? And id = ?;SELECT @@ROWCOUNT",
            "params" => [
                $account_id,
                $id
            ],
