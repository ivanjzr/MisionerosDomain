...
//
class CustomersSubscriptionsController extends BaseController
{
    ...
    public function getLastActiveSubscription($request, $response, $args) {
        ...
        //
        $results = Query::Single("Select Top 1 * from v_sales Where customer_id = ? And app_id = ? And payment_status_id = 1 Order By id Desc", [$customer_id, $app_id]);
