...
//
class MaquetasMensajesCopiasEmailsController extends BaseController
{
    ...
    public function PaginateRecords($request, $response, $args) {
        ...
        $results = Query::PaginateRecords(
            ...
            [
                //
                "table_name" => "maquetas_mensajes_copias_emails",
    ...
    public function GetAll($request, $response, $args) {
        ...
        //
        $results = MaquetasMensajesCopiasEmails::GetAll($app_id);
        //var_dump($results); exit;
    ...
    public function GetRecord($request, $response, $args) {
        ...
        //
        $results = MaquetasMensajesCopiasEmails::GetRecordById( $app_id, $args['mensaje_id'], $args['id'] );
        //var_dump($results); exit;
    ...
    public function AddRecord($request, $response, $args) {
        ...
        //
        $email = Helper::safeVar($request->getParsedBody(), 'email2');
        ...
        $insert_results = Query::DoTask([
            ...
            "debug" => true,
            "stmt" => "
                   Insert Into maquetas_mensajes_copias_emails
                  ( app_id, maqueta_id, mensaje_id, email, active, datetime_created )
                  Values
                  ( ?, ?, ?, ?, ?, GETDATE() )
    ...
    public function UpdateRecord($request, $response, $args) {
        ...
        $update_results = Query::DoTask([
            ...
            "stmt" => "
                   Update 
                    maquetas_mensajes_copias_emails
    ...
    public function DeleteRecord($request, $response, $args) {
        ...
        $results = Query::DoTask([
            "task" => "delete",
            "stmt" => "Delete FROM maquetas_mensajes_copias_emails
                        Where app_id = ?
                        And mensaje_id = ?
                        And id = ?
                     ;SELECT @@ROWCOUNT",
