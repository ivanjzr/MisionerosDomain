...
class DepartmentsController extends BaseController
{
    ...
    public function ViewIndex($request, $response, $args) {
        //
        return $this->container->php_view->render($response, 'admin/settings/departamentos/index.phtml', [
    ...
    public static function configSearchClause($search_value){
        ...
        if ( $search_value ){
            //
            $search_clause .= " And (
                        ( t.departamento like '%$search_value%' )
                    )";
        }
    ...
    public function GetAll($request, $response, $args) {
        ...
        //
        $results = Query::GetAllByAcctId("cat_departamentos", $account_id);
        //var_dump($results); exit;
    ...
    public function GetRecord($request, $response, $args) {
        ...
        //
        $results = Query::GetRecordById("cat_departamentos", $account_id, $args["id"]);
        //var_dump($results); exit;
    ...
    public function AddRecord($request, $response, $args) {
        ...
        //
        $departamento = Helper::safeVar($request->getParsedBody(), 'departamento');
        ...
        $insert_results = Query::DoTask([
            ...
            "stmt" => "
                  ...
                  ( account_id, departamento, description, active, datetime_created )
                  Values
                  ( ?, ?, ?, ?, GETDATE() )
    ...
    public function DeleteRecord($request, $response, $args) {
        ...
        $results = Query::DoTask([
            "task" => "delete",
            "stmt" => "Delete FROM cat_departamentos Where account_id = ? And id = ?;SELECT @@ROWCOUNT",
            "params" => [
                $account_id,
                $id
            ],
