define(function(){
    function moduleReady(modal, section_data){
        ...
        // modal title
        $('#modal-title').text("Copia de Telefonos Mensaje folio #" + section_data.id);
        ...
        function setAddMode(){
            ...
            add_edit_url = app.admin_url + "/templates-messages/" + section_data.id + "/copias-phones";
            //
            $("#phone_number2").focus();
        }
        ...
        //
        function setEditMode(record_id, phone_cc, phone_number, active){

            //
            $("#phone_cc2").val(phone_cc);
            $("#phone_number2").val(phone_number);
            ...
            add_edit_url = app.admin_url + "/templates-messages/" + section_data.id + "/copias-phones/" + record_id;
            //
            $("#phone_number2").focus();
        }
        ...
        //
        dataGrid({
            gridId: "#grid_copias_phones",
            url: app.admin_url + "/templates-messages/" + section_data.id + "/copias-phones",
            columns: [
                ...
                {"title": "telefono", "data" : function(obj) {
            ...
            gridReady: function(){
                ...
                $('.btn-editar-record').click(function(e) {
                    ...
                    $.ajax({
                        type:'GET',
                        url: app.admin_url + "/templates-messages/" + section_data.id + "/copias-phones/" + subsection_data.id,
                        success:function(response2){
                            ...
                            if ( response2 && response2.id ){
                                //
                                setEditMode(response2.id, response2.phone_cc, response2.phone_number, response2.active);
                            }
                            //
                ...
                $('.btn-eliminar-record').click(function(e){
                    ...
                    if (confirm("Eliminar registro con folio " + subsection_data.id + "?")){
                        ...
                        $.ajax({
                            type:'POST',
                            url: app.admin_url + "/templates-messages/" + section_data.id + "/copias-phones/del",
                            data: $.param({
                            ...
                            success:function(response2){
                                ...
                                if (response2.id){
                                    ...
                                    $("#grid_copias_phones").DataTable().ajax.reload();
                                    //
