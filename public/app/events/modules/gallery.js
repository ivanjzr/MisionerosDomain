define(function(){
    function moduleReady(section_data){
        ...
        //
        app.createSection({
            gridId: "#grid_evento_images",
            section_title: "Eventos Images",
            data: section_data,
            section_title_singular: "Evento Image",
            scripts_path: "/app/eventos/eventos",
            ...
            onGridReady: function(opts){
                ...
                //
                $("#grid_evento_images .btn-view-download-file").click(function(e){
                    e.preventDefault();
                    //
                        ...
                        $('#form_gallery').ajaxSubmit({
                            ...
                            success: function(response){
                                ...
                                if (response && response.id){
                                    ...
                                    //
                                    $("#grid_evento_images").DataTable().ajax.reload();
