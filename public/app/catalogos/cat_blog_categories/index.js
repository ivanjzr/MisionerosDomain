(function ($) {
    ...
    * */
    app.createSection({
        section_title: "Blog Categories",
        section_title_singular: "Blog Category",
        scripts_path: "/app/catalogos/cat_blog_categories",
        endpoint_url: app.admin_url + "/cat/blog-categories",
        gridOptions:{
            columns: [
        ...
        * */
        onEditReady: function(section_data){
            ...
            //
            $("#category").val(section_data.category);
