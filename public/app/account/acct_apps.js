define(function(){
    function moduleReady(section_data){
        ...
        app.createSection({
            ...
            scripts_path: "/app/patients",
            endpoint_url: app.admin_url + "/patients/" + section_data.id + "/relatives",
            gridOptions:{
                columns: [
            ...
            onGridReady: function(opts){
                ...
                $('.btn-editar').click(function(e) {
                    ...
                    loadModalV2({
                        ...
                        modal_size: "xl",
                        data: record_data,
                        html_tmpl_url: "/app/patients/modals/relatives/edit.html?v=" + dynurl(),
                        js_handler_url: "/app/patients/modals/relatives/edit.js?v=" + dynurl(),
        ...
        $('#btnAddRelative').click(function(e) {
            ...
            loadModalV2({
                ...
                modal_size: "xl",
                data: section_data,
                html_tmpl_url: "/app/patients/modals/relatives/add.html?v=" + dynurl(),
                js_handler_url: "/app/patients/modals/relatives/add.js?v=" + dynurl(),
                onBeforeLoad: function(){
                    disable_btns();
                },
                onInit: function(){
        ...
        app.filterCustomerRelatives = function(){
            ...
            $("#grid_customer_relatives").DataTable().ajax.url(app.admin_url + "/patients/" + section_data.id + "/relatives");
